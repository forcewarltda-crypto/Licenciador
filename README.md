...
## Pagina inicial incluida

`index.html` e uma copia identica da pagina `novo.html` aprovada, com os quatro
passos e sem o suporte GTA 5. Imagens, JS, termos e privacidade acompanham.

- https://keysteam.com.br/ apresenta o passo a passo no navegador.
- https://keysteam.com.br/install.ps1 entrega o script PowerShell.
- Visitar a pagina nao executa o instalador.

Envie todos os arquivos e pastas desta entrega a raiz do repositorio,
preservando outros arquivos existentes. Nao envie apenas o ZIP.

ATENCAO: o botao Baixar Executor da pagina ainda usa a configuracao original
v4.6.6 em js/force-war-config.js. O link da pagina e a URL/hash do install.ps1
sao configuracoes separadas. Antes de distribuir, configure ambos para a
versao desejada. O install.ps1 deste pacote ainda tem URL e hash vazios.
Se ja preencheu esses campos no GitHub, preserve o install.ps1 configurado
em vez de sobrescreve-lo com este modelo.
